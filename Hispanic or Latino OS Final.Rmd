...
sum(filtered_imputed_list[[22]]$combined_race_ethnicity == "Hispanic or Latino")
...
# Nerest Neighbor Matching - With Caliper = 0.1
...
# saveRDS(all_smds_3, "all_smds_3_Hispanic or Latino_NNM02.rds")
# saveRDS(a, "Hispanic or Latino_NNM02_SMD_Prop.rds")
ggsave("Hispanic or Latino_NNM02_SMD_Prop.png", a, width = 8, height = 6)
...
library(ggplot2)
all_eps$treatment <- factor(all_eps$treatment, levels = c(0, 1), labels = c("White", "Hispanic or Latino"))
...
saveRDS(my_plot, "Hispanic or Latino_density.rds")
...
saveRDS(my_plot, "Hispanic or Latino_boxplot.rds")
...
ps_combined$treatment <- factor(ps_combined$treatment, levels = c(0, 1), labels = c("White", "Hispanic or Latino"))


plot_nnm0.1 <-  ggplot(ps_combined, aes(x = ps, fill =as.factor(treatment))) +
geom_density(alpha = 0.6) + scale_fill_manual(values = c("White" = "blue", "Hispanic or Latino" = "pink")) +
  labs(x = "PS",
     fill ="Race/Ethnicity") +
theme_minimal() + theme(legend.position = "none")
print(plot_nnm0.1)
saveRDS(plot_nnm0.1, "Hispanic or Latino_NNM_0.1_PS.rds")
```
...
# saveRDS(all_smds_3, "all_smds_3_Hispanic or Latino_NNM02.rds")
# saveRDS(a, "Hispanic or Latino_NNM02_SMD_Prop.rds")
ggsave("Hispanic or Latino_NNM_SMD_Prop.png", a, width = 8, height = 6)
...
saveRDS(plot_nnm, "Hispanic or Latino_NNM_PS.rds")
...
ps_density_data$treatment <- factor(ps_density_data$treatment, levels = c(0, 1), labels = c("White", "Hispanic or Latino"))


p <- ggplot(ps_density_data, aes(x = ps, fill = as.factor(treatment))) + # Replace with your group var
geom_density(alpha = 0.6) + scale_fill_manual(values = c("White" = "blue", "Hispanic or Latino" = "pink")) + labs(x = "PS",
y = "Density", fill = "Race/Ethnicity") + theme_minimal() 


saveRDS(p, "Hispanic or Latino_unmatched_ps.rds")
``` 
...
# saveRDS(all_smds_3, "all_smds_3_Hispanic or Latino_NNM02.rds")
# saveRDS(a, "Hispanic or Latino_NNM02_SMD_Prop.rds")
ggsave("Hispanic or Latino_optimal_SMD_Prop.png", a, width = 8, height = 6)
...
theme_minimal() + theme(legend.position = "none")
print(plot_optimal)
saveRDS(plot_optimal, "Hispanic or Latino_optimal_PS.rds")
library(dplyr)
...
# saveRDS(all_smds_3, "all_smds_3_Hispanic or Latino_NNM02.rds")
# saveRDS(a, "Hispanic or Latino_NNM02_SMD_Prop.rds")
ggsave("Hispanic or Latino_SIPTW_SMD_Prop.png", a, width = 8, height = 6)
...
# saveRDS(all_smds_3, "all_smds_3_Hispanic or Latino_NNM02.rds")
# saveRDS(a, "Hispanic or Latino_NNM02_SMD_Prop.rds")
ggsave("Hispanic or Latino_IPTWTRIM_SMD_Prop.png", a, width = 8, height = 6)
...
avg_weights_df$treatment <- factor(avg_weights_df $treatment, levels = c(0, 1), labels = c("White", "Hispanic or Latino"))
...
saveRDS(plot_trimming_iptw, "Hispanic or Latino_trimming.rds")
...
saveRDS(plot_sta_iptw, "Hispanic or Latino_sta_iptw.rds")
...
dplyr::mutate(imputation = i)
  ...
  for (s in unique(imputed_subset$strata)) { 
    ...
    imputed_subset$treatment <- factor( imputed_subset$treatment, levels = c(0, 1), labels = c("White", "Hispanic or Latino"))
     ...
     saveRDS(my_plot, "Hispanic or Latino_strata.rds")
...
x = "Stratum",
y = "PS",
fill = "Race/Ethnicity") +scale_fill_manual(values = c("0" = "#F8766D", "1" = "#00BFC4"),
labels = c("White", "Hispanic or Latino")) + theme_minimal()

saveRDS(plot, "Hispanic or Latino_PS stratification.rds")
...
# saveRDS(all_smds_3, "all_smds_3_Hispanic or Latino_NNM02.rds")
# saveRDS(a, "Hispanic or Latino_NNM02_SMD_Prop.rds")
ggsave("Hispanic or Latino_STRATA_SMD_Prop.png", a, width = 8, height = 6)
...
saveRDS(b, "Hispanic or Latino_table.rds")
```
...
my_plot <- ggplot(c,  aes(y = Method, x = Hazard_Ratio)) + geom_point(size = 2, color = "blue") + # Plot HR 
  ...
  labs(title = "Hazard Ratios for White vs. Hispanic or Latino ", x = "Hazard Ratio", y = "Method") + coord_cartesian(xlim = c(0.6,1.1)) + theme_minimal()

saveRDS(my_plot, "Hispanic or Latino_HR.rds")
```
...
df <- readRDS("Hispanic or Latino_table.rds") %>%
mutate(
...
# )
# saveRDS(my_plot, "Hispanic or Latino_Forest.rds")
...
saveRDS(my_plot, file = "Hispanic or Latino_balance.rds")
```
...
mutate(`Race/Ethnicity` = ifelse(treatment == 0, "White", "Hispanic or Latino")) %>%
...
mutate(
Race = ifelse(`Race/Ethnicity` == "White", "White", "Hispanic or Latino"),
...
relocate(Method, White,`Hispanic or Latino`)
...
`Hispanic or Latino` = round(nnm_tbl$Original_N[nnm_tbl$treatment == 1],0)
) 

original_row$White <- as.character(original_row$White)
original_row$`Hispanic or Latino`<- as.character(original_row$`Hispanic or Latino`)
...
saveRDS(a, "Hispanic or Latino_sample loss.rds")
```


# Complete data analysis comparison
```{r}
completed_data <- read.csv("Hispanic or Latino_complete_data_results.csv")
...
saveRDS(p, "Hispanic or Latino_comparison")
```
...
ggdraw() + draw_image("Hispanic or Latino_NNM02_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Hispanic or Latino_NNM_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Hispanic or Latino_optimal_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Hispanic or Latino_SIPTW_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Hispanic or Latino_IPTWTRIM_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Hispanic or Latino_STRATA_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
# Save combined panel
ggsave("Hispanic or Latino_combined_panel.png", combined, width = 10, height = 10)
