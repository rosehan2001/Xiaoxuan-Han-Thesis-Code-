...
races_to_keep <- c("White", "Other Races" )
...
sum(filtered_imputed_list[[22]]$combined_race_ethnicity == "Other Races")
...
# saveRDS(all_smds_3, "all_smds_3_Other Races_NNM02.rds")
# saveRDS(a, "Other Races_NNM02_SMD_Prop.rds")
ggsave("Other Races_NNM02_SMD_Prop.png", a, width = 8, height = 6)
...
library(ggplot2)
all_eps$treatment <- factor(all_eps$treatment, levels = c(0, 1), labels = c("White", "Other Races"))
...
saveRDS(my_plot, "Other Races_density.rds")
...
saveRDS(my_plot, "Other Races_boxplot.rds")
...
ps_combined$treatment <- factor(ps_combined$treatment, levels = c(0, 1), labels = c("White", "Other Races"))


plot_nnm0.1 <-  ggplot(ps_combined, aes(x = ps, fill =as.factor(treatment))) +
geom_density(alpha = 0.6) + scale_fill_manual(values = c("White" = "blue", "Other Races" = "pink")) +
labs(x = "PS",
     fill ="Race/Ethnicity") +
theme_minimal() + theme(legend.position = "none")
print(plot_nnm0.1)
saveRDS(plot_nnm0.1, "Other Races_NNM_0.1_PS.rds")
```
...
# saveRDS(all_smds_3, "all_smds_3_Other Races_NNM02.rds")
# saveRDS(a, "Other Races_NNM02_SMD_Prop.rds")
ggsave("Other Races_NNM_SMD_Prop.png", a, width = 8, height = 6)
...
saveRDS(plot_nnm, "Other Races_NNM_PS.rds")
...
ps_density_data$treatment <- factor(ps_density_data$treatment, levels = c(0, 1), labels = c("White", "Other Races"))


p <- ggplot(ps_density_data, aes(x = ps, fill = as.factor(treatment))) + # Replace with your group var
geom_density(alpha = 0.6) + scale_fill_manual(values = c("White" = "blue", "Other Races" = "pink")) + labs(x = "PS",
y = "Density", fill = "Race/Ethnicity") + theme_minimal() 


saveRDS(p, "Other Races_unmatched_ps.rds")
``` 
...
# saveRDS(all_smds_3, "all_smds_3_Other Races_NNM02.rds")
# saveRDS(a, "Other Races_NNM02_SMD_Prop.rds")
ggsave("Other Races_optimal_SMD_Prop.png", a, width = 8, height = 6)
...
theme_minimal() + theme(legend.position = "none")
print(plot_optimal)
saveRDS(plot_optimal, "Other Races_optimal_PS.rds")
library(dplyr)
...
# saveRDS(all_smds_3, "all_smds_3_Other Races_NNM02.rds")
# saveRDS(a, "Other Races_NNM02_SMD_Prop.rds")
ggsave("Other Races_SIPTW_SMD_Prop.png", a, width = 8, height = 6)
...
# saveRDS(all_smds_3, "all_smds_3_Other Races_NNM02.rds")
# saveRDS(a, "Other Races_NNM02_SMD_Prop.rds")
ggsave("Other Races_IPTWTRIM_SMD_Prop.png", a, width = 8, height = 6)
...
avg_weights_df$treatment <- factor(avg_weights_df $treatment, levels = c(0, 1), labels = c("White", "Other Races"))
...
saveRDS(plot_trimming_iptw, "Other Races_trimming.rds")
...
saveRDS(plot_sta_iptw, "Other Races_sta_iptw.rds")
...
dplyr::mutate(imputation = i)
  ...
  for (s in unique(imputed_subset$strata)) { 
    ...
    imputed_subset$treatment <- factor( imputed_subset$treatment, levels = c(0, 1), labels = c("White", "Other Races"))
     ...
     saveRDS(my_plot, "Other Races_strata.rds")
...
fill = "Race/Ethnicity") + scale_fill_manual(values = c("0" = "blue", "1" = "pink"),
  labels = c("White", "Other Races")) + theme_minimal()

saveRDS(plot, "Other Races_PS stratification.rds")
...
# saveRDS(all_smds_3, "all_smds_3_Other Races_NNM02.rds")
# saveRDS(a, "Other Races_NNM02_SMD_Prop.rds")
ggsave("Other Races_STRATA_SMD_Prop.png", a, width = 8, height = 6)
...
saveRDS(b, "Other Races_table.rds")
```
...
my_plot <- ggplot(c,  aes(y = Method, x = Hazard_Ratio)) + geom_point(size = 2, color = "blue") + # Plot HR 
  ...
  labs(title = "Hazard Ratios for White vs. Other Races ", x = "Hazard Ratio", y = "Method") + coord_cartesian(xlim = c(0.4,1.7)) + theme_minimal()

saveRDS(my_plot, "Other Races_HR.rds")
```
...
df <- readRDS("Other Races_table.rds") %>%
mutate(
...
# )
# saveRDS(my_plot, "Other Races_Forest.rds")
...
saveRDS(my_plot, file = "Other Races_balance.rds")
```
...
mutate(`Race/Ethnicity` = ifelse(treatment == 0, "White", "Other Races")) %>%
...
mutate(
Race = ifelse(`Race/Ethnicity` == "White", "White", "Other Races"),
...
relocate(Method, White,`Other Races`)
...
`Other Races` = round(nnm_tbl$Original_N[nnm_tbl$treatment == 1],0)
) 

original_row$White <- as.character(original_row$White)
original_row$`Other Races`<- as.character(original_row$`Other Races`)
...
saveRDS(a, "Other Races_sample loss.rds")
```


# Complete data analysis comparison
```{r}
completed_data <- read.csv("Other Races_complete_data_results.csv")
...
ggdraw() + draw_image("Other Races_NNM02_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Other Races_NNM_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Other Races_optimal_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Other Races_SIPTW_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Other Races_IPTWTRIM_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
ggdraw() + draw_image("Other Races_STRATA_SMD_Prop.png"),
ncol = 1,
rel_heights = c(0.1, 1)
)
...
# Save combined panel
ggsave("Other Races_combined_panel.png", combined, width = 10, height = 10)
